...
document.addEventListener("load", function() {
    var url = window.location.href
    var mcolor = url ? url.split('?')[1].split('+')[1] : window.location.search.slice(1);
    var cscolor = mcolor
